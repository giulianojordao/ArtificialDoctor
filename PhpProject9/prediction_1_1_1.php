			 ...
			 if( strcmp($str1, $str2) ==0)
                        {
                            $id=$row['idd'];
			   if($score[$id] > 0)  $score[$id] = $score[$id]+1;
                            echo "Your symptom has matched with symptom of ".$row['diseasee']." this diseas is mostly seen in ".$row['diseasee']."so present increased score of disease is".$score[$id]." <br> ";

...
<body>
  <div class="body"></div>
		...
		<br>
		<div class="login">
                    <FORM ACTION="userdata_1.php" METHOD="POST">
                        <input type="text" placeholder="idd" name="idd"><br>
				<input type="text" placeholder="disease" name="disease"><br>
				<input type="text" placeholder="major symptoms" name="majorsymptoms"><br>
				<input type="text" placeholder="minor symptom" name="minorsymptom"><br>
